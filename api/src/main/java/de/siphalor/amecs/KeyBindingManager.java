...
public class KeyBindingManager {
    ...
    private static boolean areExactModifiersPressed(KeyBinding keyBinding) {
        return TMSKeyBindingManager.INSTANCE.getCurrentModifiers().equals(TMSKeyBindingUtils.getBoundModifiersOrEmpty(keyBinding));
    }
    ...
    public static void setKeyPressed(InputUtil.Key keyCode, boolean pressed) {
        ...
        if (modifier != null) {
            TMSKeyBindingManager.INSTANCE.getCurrentModifiers().set(modifier, pressed);
        }
    ...
    private static void handleReleasedModifier() {
        ...
        pressedKeyBindings.removeIf(pressedKeyBinding -> {
            ...
            if (!TMSKeyBindingManager.INSTANCE.getCurrentModifiers().contains(boundModifiers)) {
                //TMSKeyBindingManager.INSTANCE.log(Level.DEBUG, "Undressing keybinding due to released modifier: " + pressedKeyBinding.getTranslationKey());
