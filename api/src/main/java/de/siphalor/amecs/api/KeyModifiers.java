...
public class KeyModifiers {
    ...
    public static KeyModifiers getCurrentlyPressed() {
        return TMSKeyBindingManager.INSTANCE.getCurrentModifiers().toAmecs();
    }
    ...
    public boolean isPressed() {
        return equals(TMSKeyBindingManager.INSTANCE.getCurrentModifiers());
    }
    ...
    public boolean equals(Object obj) {
        ...
        } else if (obj instanceof BindingModifiers) {
            return equals(((BindingModifiers) obj).toAmecs());
        }
        return false;
    }
