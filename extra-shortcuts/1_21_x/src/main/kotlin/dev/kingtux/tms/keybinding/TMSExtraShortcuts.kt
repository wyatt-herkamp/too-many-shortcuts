...
import dev.kingtux.tms.keybinding.shortcuts.SkinLayerKeyBinding
import dev.kingtux.tms.keybinding.shortcuts.ToggleAutoJumpKeyBinding
...
object TMSExtraShortcuts : ClientModInitializer {
    const val MOD_ID = "tms_extra_shortcuts"

    const val MOD_NAME = "Too Many Shortcuts"
    const val SKIN_LAYER_CATEGORY: String = "$MOD_ID.key.categories.skin_layers"

    val LOGGER: Logger = LogManager.getLogger(TMSExtraShortcuts.javaClass)
