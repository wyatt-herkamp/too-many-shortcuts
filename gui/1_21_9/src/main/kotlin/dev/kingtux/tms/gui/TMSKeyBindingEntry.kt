...
abstract class TMSKeyBindingEntry(
    ...
    private val editButton: ButtonWidget =
        ButtonWidget.builder(Text.translatable(binding.id)) {
    ...
    init {
        val descriptionKey = binding.id + DESCRIPTION_SUFFIX
...
class TMSKeyBindingParentEntry constructor(
    ...
    override val bindingName: Text = Text.translatable(binding.id)
